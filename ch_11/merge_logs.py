...
if __name__ == '__main__':
    ...
    logs_2018['2018'].to_csv('logs/logs_2018.csv') # sometimes the simulation overshoots the end date

    logs_2019 = pd.concat([cat_csvs('logs/{}_2019.csv', 'datetime', ['jan', 'feb', 'mar']), logs_2018.get('2019')]).sort_index()
    ...
    hackers_2018['2018'].to_csv('logs/hackers_2018.csv')

    hackers_2019 = pd.concat([
        cat_csvs('logs/hackers_{}_2019.csv', 'start', ['jan', 'feb', 'mar']), hackers_2018.get('2019')
    ]).sort_index()
    hackers_2019['2019-Q1'].to_csv('logs/hackers_2019.csv')
