...
- [`3-aggregations.ipynb`](./3-aggregations.ipynb): discusses how to perform aggregations on the data, including calculations by group membership (with the `groupby()` method), pivot tables, and crosstabs
